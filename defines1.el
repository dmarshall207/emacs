...
;; :old : (defalias 'substr  'substring)
(defmacro substr (str from &optional to)
  `(condition-case nil
      (substring ,str ,from ,to)
    (error nil)))                           ;; :dm <--- 'error' is like 'else'

;; :old :  (defalias 'm-str   'match-string)
(defmacro m-str (group &optional str)
  `(condition-case nil
...
;;/  :color
(defalias 'color?   'color-defined-p)
;;/  :color
(defalias 'color?   'color-defined-p)
